...
export const Register = () => {
    ...
    const registerNewCustomer = () => {
        // return fetch("https://glitch.com/edit/#!/fitgeneration-api/database.json/customers", {
        return fetch("https://glitch.com/edit/#!/fitgeneration-api/database.json/customers", {
            method: "POST",
            headers: {
    ...
    const handleRegister = (e) => {
        e.preventDefault()
        // return fetch(`https://glitch.com/edit/#!/fitgeneration-api/database.json/customers?email=${customer.email}`)
        return fetch(`https://glitch.com/edit/#!/fitgeneration-api/database.json/customers?email=${customer.email}`)
            .then(res => res.json())
            .then(response => {
